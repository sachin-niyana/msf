  ...
  return (
    <div className="bg-zircon">
      <div className="container mx-auto px-3 max-w-[1152px] relative lg:pt-32 lg:pb-24 md:py-20 sm:py-16 py-12 bg-lines-bg !bg-cover bg-center w-full">
        ...
        <p className="text-mirage mx-auto text-base text-center sm:leading-[237.5%] leading-[150%] max-w-[900px] md:mt-7 mt-3 font-normal font-Inter">
        ...
        <div
          className="flex bg-mirage justify-center items-end flex-wrap md:mt-9 mt-8 lg:mb-2"
          data-aos="flip-down"
